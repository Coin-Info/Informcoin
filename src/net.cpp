...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Informcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"informcointools.coininfo.review", "node1.coininfo.review"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"informcointools.com", "testnet-seed.informcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Informcoin is probably already running."), addrBind.ToString().c_str());
        else
