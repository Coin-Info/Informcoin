#############################################################################
# Makefile for building: informcoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Fri May 11 22:02:15 2018
# Project:  informcoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_QRCODE=1 USE_UPNP=- USE_IPV6=1 -o Makefile informcoin-qt.pro
#############################################################################
...
Makefile: informcoin-qt.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=- USE_IPV6=1 -o Makefile informcoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/Informcoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/Informcoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/Informcoin/src/leveldb/libleveldb.a: FORCE
	cd C:/Informcoin/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -fno-keep-inline-dllexport -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a && ranlib C:/Informcoin/src/leveldb/libleveldb.a && ranlib C:/Informcoin/src/leveldb/libmemenv.a
